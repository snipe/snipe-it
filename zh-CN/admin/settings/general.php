...
return array(
    ...
    'auto_incrementing_help'    => '请先启用自动递增的资产ID再设置此处。',
    'backups'					=> '备份',
    'barcode_settings'			=> '条码设置',
    'confirm_purge'			    => '确认清除',
    'confirm_purge_help'		=> '请在文本框内输入“DELETE” 清除已经标记删除的记录。 注意，此操作无法撤销。',
    'custom_css'				=> '自定义 CSS',
    'custom_css_help'			=> '键入你喜欢的CSS格式覆盖。不要包括：&lt;style&gt;&lt;/style&gt; 标签。',
    'custom_forgot_pass_url'	=> '自定义密码重置网址',
    'custom_forgot_pass_url_help'	=> '这将替换登录页面上默认的忘记密码URL，有助于将用户引导至内部或托管的LDAP密码重置服务。它将禁用本地用户密码重置功能。',
    'dashboard_message'			=> '仪表盘消息',
    'dashboard_message_help'	=> '此文本将显示在仪表盘上，供有权查看仪表盘的任何人使用。',
    'default_currency'  		=> '默认货币',
    'default_eula_text'			=> '默认的最终用户许可协议(EULA)',
    ...
    'email_logo_size'       => '电子邮件中的方形标志看起来最好。 ',
    'eula_settings'				=> '最终用户许可协议(EULA)设置',
    'eula_markdown'				=> '最终用户许可协议(EULA)中可以使用<a href="https://help.github.com/articles/github-flavored-markdown/">Github flavored markdown</a>.',
    'favicon'                   => '网站图标',
    'favicon_format'            => '可接受的文件类型是ico、png和gif。其他图像格式可能无法在所有浏览器中显示。',
    'favicon_size'          => 'Favicon应该是方形图像，16x16像素。',
    'footer_text'               => '附加页脚文本 ',
    ...
    'ldap_login_test_help'      => '根据你指定的base DN，输入有效的LDAP用户名和密码，以测试您的LDAP登录是否配置正确。<b>您必须先保存您更改的LDAP设置。</b>',
    'ldap_login_sync_help'      => '这只证明了LDAP同步正确。如果您的LDAP身份验证查询设置不正确，用户可能仍然无法登录。<b>您必须先保存您的LDAP设置。</b>',
    'ldap_server'               => 'LDAP 服务器',
    'ldap_server_help'          => '这应以ldap:// (非加密或者使用TLS加密)或 ldaps:// (使用SSL加密)开头',
    ...
    'ldap_pw_sync_help'         => '若您不想让 LDAP 密码与系统密码同步，请取消勾选此项。取消同步设置将造成当系统与 LDAP 失去连接时，用户可能由于某些原因无法登录。',
    'ldap_username_field'       => '用户名字段',
    'ldap_lname_field'          => '姓氏',
    'ldap_fname_field'          => 'LDAP用户名字字段',
    'ldap_auth_filter_query'    => 'LDAP认证请求',
    'ldap_version'              => 'LDAP 版本',
    'ldap_active_flag'          => 'LDAP 活动标志',
    ...
    'login_remote_user_header_name_text' => '自定义用户名头部',
    'login_remote_user_header_name_help' => '使用指定的头部而不是REMOTE_USER',
    'logo'                    	=> '标志',
    ...
    'show_images_in_email_help'   => '如果您的Snipe-IT部署在VPN后或者内部网络，外部用户无法直接通过互联网加载来自Snipe-IT上的图像，请取消此复选框。',
    'site_name'                 => '站点名称',
    'slack_botname'             => 'Slack Bot名称',
    'slack_channel'             => 'Slack频道',
    'slack_endpoint'            => 'Slack节点',
    'slack_integration'         => 'Slack设置',
    'slack_integration_help'    => '您也可以选择与Slack系统集成，不过您需要提供Slack的节点和频道。请先在您的Slack账户中 <a href=":slack_link" target="_new" rel="noopener">创建一个新的incoming webhook </a> ',
    'slack_integration_help_button'    => '一旦你保存了你的Slack信息，就会出现一个测试按钮。',
    'slack_test_help'           => '测试您的Slack集成是否配置正确。<b>请要先保存你的设置</b>。',
    ...
    'width_w'        => '宽',
    'height_h'        => '高',
    'show_url_in_emails'                => '在电子邮件到Snipe-IT的链接',
    'show_url_in_emails_help_text'      => '如果您不希望电子邮件页脚中带有到Snipe-IT的链接，请取消选中此框。如果您的大多数用户从不登录，这会很有用。 ',
    'text_pt'        => '磅',
    'thumbnail_max_h'   => '最大缩略图高度',
    'thumbnail_max_h_help'   => '缩略图可能在列表视图中显示的最大高度。最小25，最大500。',
    'two_factor'        => '两步验证',
    ...
    'require_accept_signature_help_text'      => '启用此功能将需要用户手写签字来接受一项资产。',
    'left'        => '左',
    'right'        => '右',
    'top'        => '顶部',
    'bottom'        => '底部',
    ...
    'username_format_help'   => '此设置仅用于导入过程没有提供用户名而自动生成一个用户名。',
);
