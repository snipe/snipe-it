...
return array(
    ...
    'is_ad'				        => 'Questo è un server Active Directory',
    'alert_email'				=> 'Invia avvisi a',
    'alerts_enabled'			=> 'Avvisi Email Abilitati',
    'alert_interval'			=> 'Soglia di avviso di scadenza (in giorni)',
    'alert_inv_threshold'		=> 'Soglia di avviso dell\'inventario',
    'asset_ids'					=> 'ID Bene',
    ...
    'audit_warning_days'        => 'Soglia di allarme controllo',
    'audit_warning_days_help'   => 'Quanti giorni in anticipo dovremmo avvisare quando i beni devono essere controllati?',
    'auto_increment_assets'		=> 'Genera ID Beni auto-incrementale',
    'auto_increment_prefix'		=> 'Prefisso (Opzionale)',
    'auto_incrementing_help'    => 'Abilita gli ID auto-incrementali prima di effettuare questa selezione',
    'backups'					=> 'Backups',
    ...
    'custom_css_help'			=> 'Inserisci qualsiasi CSS personalizzato che vorresti usare. Non includere i tag &lt;style&gt;&lt;/style&gt;.',
    ...
    'default_eula_help_text'	=> 'È inoltre possibile associare EULA personalizzate a categorie specifiche di beni.',
    'display_asset_name'        => 'Mostra Nome Bene',
    'display_checkout_date'     => 'Mostra Data Checkout',
    'display_eol'               => 'Visualizza EOL nella vista tabella',
    'display_qr'                => 'Visualizza codici quadrati',
    'display_alt_barcode'		=> 'Visualizza codice a barre 1D',
    ...
    'eula_markdown'				=> 'Questo campo consente l\'uso del <a href="https://help.github.com/articles/github-flavored-markdown/">Markdown di Github </a>.',
    'favicon'                   => 'Favicon',
    'favicon_format'            => 'Tipi di file accettati sono ico, png e gif. Altri formati di immagine potrebbero non funzionare in tutti i browser.',
    'favicon_size'          => 'Le Favicons dovrebbero essere immagini quadrate, 16x16 pixel.',
    'footer_text'               => 'Ulteriore testo di piè di pagina ',
