...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    @if ($item->id)
     <form id="create-form" class="form-horizontal" method="post" action="{{ route('update/hardware',$item->id) }}" autocomplete="off" role="form" enctype="multipart/form-data">
   @else
    ...
    <div class="box box-default">
      @if ($item->id)
        <div class="box-header with-border">
          <h3 class="box-title">{{ $item->showAssetName() }}</h3>
        </div><!-- /.box-header -->
      @endif
