      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-teal">
          ...
          <div class="icon">
            ...
            @can('assets.view')
                <a href="{{ route('hardware') }}" class="small-box-footer">{{ trans('general.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
             @endcan
        </div>
      </div><!-- ./col -->
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-maroon">
          ...
          <div class="icon">
            ...
            @can('licenses.view')
                <a href="{{ route('licenses') }}" class="small-box-footer">{{ trans('general.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
            @endcan
        </div>
      </div><!-- ./col -->
        ...
        <div class="small-box bg-orange">
          ...
          <div class="icon">
            ...
            @can('accessories.view')
                <a href="{{ route('accessories') }}" class="small-box-footer">{{ trans('general.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
            @endcan
        </div>
      </div><!-- ./col -->
        ...
        <div class="small-box bg-purple">
          ...
          <div class="icon">
            ...
            @can('consumables.view')
                <a href="{{ route('consumables') }}" class="small-box-footer">{{ trans('general.more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
            @endcan
        </div>
      </div><!-- ./col -->
