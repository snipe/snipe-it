        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h2 class="box-title">{{ trans('general.dashboard_welcome_message') }}</h2>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-yellow" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%">
                                    <span class="sr-only">{{ trans('general.dashboard_60_percent') }}</span>
                                </div>
                            </div>


                            <p><strong>{!! trans('general.dashboard_nothing_added_message') !!}</strong></p>
...
<div class="row">
  ...
  <div class="col-md-4">
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">{{ trans('general.assets') }} by {{ trans('general.status') }}</h2>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse" aria-hidden="true">
                        <i class="fas fa-minus" aria-hidden="true"></i>
                        <span class="sr-only">{{ trans('general.collapse') }}</span>
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <th class="col-sm-1" data-visible="true" data-field="assets_count" data-sortable="true">
                                    <i class="fas fa-barcode" aria-hidden="true"></i>
                                    <span class="sr-only">{{ trans('general.asset') }} {{ trans('general.count') }}</span>
                                </th>
