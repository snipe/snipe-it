...
<div class="form-group {{ $errors->has('model_number') ? ' has-error' : '' }}">
    ...
    <input class="form-control" type="text" name="model_number" aria-label="model_number" id="model_number" value="{{ old('model_number', $item->model_number) }}" data-validation="required" required/>
