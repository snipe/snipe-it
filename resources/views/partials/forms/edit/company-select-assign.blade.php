<!-- Company -->
<div id="{{ $fieldname }}" class="form-group{{ $errors->has($fieldname) ? ' has-error' : '' }}" style='margin-bottom:0px'>
    {{ Form::label($fieldname, $translated_name, array('class' => 'col-md-4 col-xs-12 control-label')) }}
