<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
    ...
    <div class="col-md-8 col-xs-12">
        <input type="email" name="email" id="email" value="{{ old('email', $item->email ?? null) }}" class="form-control"  maxlength="191" style="width:100%; display:flex;" placeholder="{{ trans('general.example') . 'email@example.com' }}">
