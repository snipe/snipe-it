...
<div class="form-group {{ $errors->has('supplier_id') ? ' has-error' : '' }}">
    ...
    <div class="col-md-1 col-sm-1 text-left">
             <a href='{{ route('modal.supplier') }}' data-toggle="modal"  data-target="#createModal" data-dependency="supplier" data-select='supplier_select_id' class="btn btn-sm btn-default">新</a>
    </div>
</div>
