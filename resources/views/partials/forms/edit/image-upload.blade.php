...
<div class="form-group {{ $errors->has((isset($fieldname) ? $fieldname : 'image')) ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        ...
        <p class="help-block" id="uploadFile-status">{{ trans('general.image_filetypes_help', ['filetypes' => 'jpg, webp, png, gif, svg, and avif', 'size' => Helper::file_upload_max_size_readable()]) }} {{ $help_text ?? '' }}</p>
