<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
    ...
    <div class="col-md-9">
        <label class="btn btn-default">
            ...
            <input type="file" name="image" class="uploadFile" id="uploadFile" data-maxsize="{{ \App\Helpers\Helper::file_upload_max_size() }}" accept="image/gif,image/jpeg,image/png,image/svg" style="display:none; max-width: 90%">
        </label>
