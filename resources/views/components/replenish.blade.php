      ...
      <div class="box box-default">
        ...
        @if ($component->id)
          <div class="box-header with-border">
            <div class="box-heading">
              <h2 class="box-title">{{ $component->name }}   ({{ $component->numRemaining()  }} / {{ $component->qty}}  {{ trans('admin/component/general.remaining') }}) </h2>
            </div>
          </div><!-- /.box-header -->
        @endif
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">{{ trans('admin/component/general.consumable_name') }}</label>
            <div class="col-md-6">
