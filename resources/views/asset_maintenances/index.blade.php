        ...
        >
          <thead>
            <tr>
              ...
              <th data-searchable="true" data-sortable="true" data-field="start_date" data-formatter="dateDisplayFormatter">{{ trans('admin/asset_maintenances/form.start_date') }}</th>
