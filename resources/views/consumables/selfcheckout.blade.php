...
{{-- Page title --}}
@section('title')
     {{ trans('admin/consumables/general.selfcheckout') }}
@parent
@stop
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <div class="form-group {{ $errors->has('notes') ? 'error' : '' }}">
            ...
            <div class="col-md-7">
              <textarea class="col-md-6 form-control" id="notes" name="notes" readonly style="resize:none;">{{ old('note', $consumable->notes) }}</textarea>
