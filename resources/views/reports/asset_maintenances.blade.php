        ...
        <div class="table-responsive">
            ...
            <table
                ...
                <tr>
                    ...
                    <th data-sortable="true" data-field="assigned_to" data-visible="false" data-formatter="usersLinkObjFormatter">{{ trans('general.checked_out_to') }}</th>
                    <th data-sortable="true" data-field="repairer" data-visible="false" data-formatter="usersLinkObjFormatter">{{ trans('general.repairer') }}</th>
                    ...
                    <th data-sortable="true" data-field="asset_maintenance_location" data-formatter="deployedLocationFormatter" data-visible="false">{{ trans('general.asset_maintenance_location') }}</th>
