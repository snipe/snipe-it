                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <label class="btn btn-default">
                            ...
                            <input type="file" name="file[]" multiple="true" class="uploadFile" id="uploadFile" data-maxsize="{{ \App\Helpers\Helper::file_upload_max_size() }}" accept="image/*,.csv,.zip,.rar,.doc,.docx,.xls,.xml,.lic,.xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel,text/plain,.pdf" style="display:none">
                        </label>
