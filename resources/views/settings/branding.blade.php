            ...
            <div class="panel box box-default">
                ...
                <div class="box-body">
                    ...
                    @include('partials/forms/edit/uploadLogo', [
                        ...
                        "helpBlock" => trans('general.logo_size') . trans('general.filetypes_accepted_help', ['filetypes' => 'jpg, webp, png, gif, svg, and avif', 'size' => Helper::file_upload_max_size_readable()]),
                    ])
                    ...
                    @include('partials/forms/edit/uploadLogo', [
                        ...
                        "helpBlock" => trans('admin/settings/general.email_logo_size') . trans('general.filetypes_accepted_help', ['filetypes' => 'jpg, webp, png, gif, svg, and avif', 'size' => Helper::file_upload_max_size_readable()]),
                    ])
                    ...
                    @include('partials/forms/edit/uploadLogo', [
                        ...
                        "helpBlock" => trans('admin/settings/general.label_logo_size') . trans('general.filetypes_accepted_help', ['filetypes' => 'jpg, webp, png, gif, and avif', 'size' => Helper::file_upload_max_size_readable()]),
                    ])
                    ...
                    @include('partials/forms/edit/uploadLogo', [
                        ...
                        "logoPath" => "avatars/",
                        "helpBlock" => trans('general.filetypes_accepted_help', ['filetypes' => 'jpg, webp, png, gif, svg, and avif', 'size' => Helper::file_upload_max_size_readable()]),
                    ])
