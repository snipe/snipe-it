...
@section('header_right')
    ...
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('manufacturers.edit', $manufacturer->id) }}">{{ trans('admin/manufacturers/table.update') }}</a>
            </li>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="licenses">
                        @if ($manufacturer->licenses->count() > 0)
                            <table
                    ...
                    <div class="tab-pane fade" id="accessories">
                        @if ($manufacturer->accessories->count() > 0)
                        <table
              ...
              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                    ...
                    <div class="tab-pane fade" id="components">
                        @if ($manufacturer->components->count() > 0)
                        <table
              ...
              "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                    ...
                    <div class="tab-pane fade" id="consumables">
                        @if ($manufacturer->consumables->count() > 0)
                        <table
