...
return [
    ...
    'fields'                => '字段',
    'last_checkout'         => '上次借出',
    'due_to_checkin'        => '以下:count 物品将很快归还：',
    'expected_checkin'      => '预计归还日期',
    'reminder_checked_out_items' => '这是当前借出给您的物品的提醒。 如果你觉得这个列表不准确(有些东西缺失，或者你认为你从未收到的东西)，请发送电子邮件::reply_to_name 到 :reply_to_address_address。',
    'changed'               => '已修改',
    'to'                    => '至',
