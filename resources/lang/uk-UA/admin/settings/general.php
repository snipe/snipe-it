...
return [
    ...
    'general_settings_keywords' => 'підтримка компанії, підпис, згода, формат імені користувача, користувача електронної пошти, зображення на сторінку, thumbnail, eula, tos, dashboard, privacy',
    ...
    'ldap_client_tls_cert_help' => 'Сертифікат Client-Side TLS та ключ для з\'єднань LDAP, як правило, корисні лише в конфігураціях Google Workspace з "Secure LDAP". Обидва є обов\'язковими.',
     'ldap_client_tls_key'       => 'LDAP ключ Client-Side TLS',
...
'ldap_location_help'             => 'Поле LDAP Location повинно використовуватися, якщо <strong>OU не вказано у Base Bind DN.</strong> Залиште поле порожнім, якщо потрібно використовувати пошук OU.',
    ...
    'load_remote_text'          => 'Віддалені скрипти',
    'load_remote_help_text'		=> 'Ця програма Snipe-IT може завантажувати скрипти з зовнішнього світу.',
    ...
    'two_factor_reset_help'        => 'Це змусить користувача знову записувати їх пристрій за допомогою Google Authenticator. Це може бути корисно, якщо зараз їх загублено або вкрадено в даний час. ',
