...
return [
    ...
    'accept_assets'         => 'Accepteer asset :name',
    'accept_assets_menu'    => 'Assets accepteren',
    'audit'				    => 'Audit',
    'audit_report'			=> 'Auditlogboek',
    'assets'				=> 'Assets',
    'assets_audited'        => 'geauditeerde assets',
    'assets_checked_in_count'     => 'ingecheckte assets',
    'assets_checked_out_count'     => 'uitgecheckte assets',
    'asset_deleted_warning'     => 'Dit asset is verwijderd. U moet het herstellen voor u het kunt toewijzen aan iemand.',
    ...
    'bulk_checkin_delete'   => 'Bulk Check-in / Verwijderen gebruikers',
    'byod'                  => 'BYOD',
    ...
    'delete'  				=> 'Verwijder',
    'delete_confirm'  		=> 'Weet je zeker dat je :item wilt verwijderen?',
    'deleted'  				=> 'Verwijderd',
    ...
    'error'				    => 'Foutmelding',
    'exclude_archived'      => 'Gearchiveerde assets uitsluiten',
    'exclude_deleted'       => 'Verwijderde assets uitsluiten',
    'example'				=> 'Voorbeeld: ',
    ...
    'include_deleted'       => 'Verwijderde assets opnemen',
    ...
    'unaccepted_image_type'  => 'Dit afbeeldingsbestand was niet leesbaar. Geaccepteerde bestandstypen zijn jpg, webp, png, gif en svg. Het mimetype van dit bestand is: :mimetype.',
    'import'         	    => 'Importeer',
    'importing'         	=> 'Importeren',
    'importing_help'        => 'Je kunt assets, accessoires, licenties, componenten, verbruiksartikelen en gebruikers importeren via het CSV-bestand. <br><br>De CSV moet door komma\'s worden gescheiden en met koppen die overeenkomen met de koppen in de <a href="https://snipe-it.readme.io/docs/importing" target="_new">voorbeeld CSV\'s in de documentatie</a>.',
    ...
    'only_deleted'          => 'Alleen verwijderde assets',
    ...
    'requested_assets'      => 'Aangevraagde assets',
    'requested_assets_menu' => 'Aangevraagde assets',
    ...
    'skin'       			=> 'Thema',
    'webhook_msg_note'        => 'Er zal een melding worden gestuurd via webhook',
    'webhook_test_msg'        => 'Oh hai! Het lijkt er op dat je :app met Snipe-IT werkt!',
    ...
    'users'                 => 'Gebruikers',
    'viewall'				=> 'Toon alles',
    'viewassets'  			=> 'Toegewezen assets tonen',
    'viewassetsfor'         => 'Assets voor :name bekijken',
    'website'               => 'Website',
    'welcome'				=> 'Welkom :name',
    'years'					=> 'jaren',
    'yes' 					=> 'Ja',
    ...
    'report_fields_info'    => '<p>Selecteer de velden die je wilt opnemen in je aangepaste rapport en klik op Genereren. Het bestand (custom-asset-report-YY-mm-dd.csv) zal automatisch downloaden en je kunt het openen in Excel.</p>
            <p>Als je alleen bepaalde assets wilt exporteren, gebruik de onderstaande opties om je resultaten te verfijnen.</p>',
    'range'                 => 'Bereik',
    ...
    'bulk_checkin_delete_success' => 'Je geselecteerde gebruikers zijn verwijderd en hun artikelen zijn ingecheckt.',
    ...
    'skip_to_main_content'  => 'Overslaan naar de hoofdinhoud',
    'toggle_navigation'     => 'Toggle navigatie',
    'alerts'                => 'Waarschuwingen',
    'tasks_view_all'        => 'Bekijk alle taken',
    'true'                  => 'Waar',
    'false'                 => 'Onwaar',
    'integration_option'    => 'Integratieoptie',
    'log_does_not_exist'    => 'Er bestaat geen passend logboekrecord.',
    'merge_users'           => 'Gebruikers samenvoegen',
    'merge_information' =>  'Dit zal de :count gebruikers samenvoegen tot een enkele gebruiker. Selecteer hieronder de gebruiker waarin je de anderen wilt samenvoegen, en de bijbehorende middelen, licenties, enz. worden naar de geselecteerde gebruiker verplaatst en de andere gebruikers worden gemarkeerd als verwijderd.',
    'warning_merge_information' => 'Deze actie kan NIET ongedaan gemaakt worden en moet ALLEEN gebruikt worden als je gebruikers moet samenvoegen vanwege een slechte import of synchronisatie. Zorg ervoor dat je eerst een back-up maakt.',
    'no_users_selected'     => 'Geen gebruikers geselecteerd',
    'not_enough_users_selected'     => 'Er moeten minstens :count gebruikers geselecteerd zijn',
    'merge_success'         => ':count gebruikers succesvol samengevoegd in :into_username!',
    'merged'                => 'samengevoegd',
    'merged_log_this_user_into' => 'Gebruiker (ID :to_id - :to_username) samengevoegd in gebruikers-ID :from_id (:from_username) ',
    'merged_log_this_user_from' => 'Gebruikers-ID :from_id (:from_username) samengevoegd in deze gebruiker (ID :to_id - :to_username)',
    'clear_and_save'            => 'Leeg en sla op',
    'update_existing_values'    => 'Bestaande waarden bijwerken?',
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Het automatisch aanvullen van asset tags is uitgeschakeld, dus voor alle rijen moet de kolom "Asset Tag" ingevuld zijn.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Opmerking: Het automatisch aanvullen van asset tags is ingeschakeld, zodat assets worden aangemaakt voor rijen waarin geen "Asset Tag" is ingevuld. Rijen waar wel "Asset Tag" is ingevuld worden bijgewerkt met de verstrekte informatie.',
    'send_welcome_email_to_users'   => ' Stuur welkomstmail naar nieuwe gebruikers?',
    'back_before_importing'     => 'Backup voor importeren?',
    'csv_header_field'          => 'CSV Header Veld',
    'import_field'              => 'Import Veld',
    'sample_value'              => 'Voorbeeld Waarde',
    'no_headers'                => 'Geen Kolommen Gevonden',
    'error_in_import_file'      => 'Er was een probleem bij het lezen van CSV bestand: :error',
    'percent_complete'          => ':percent % Voltooid',
    'errors_importing'          => 'Er zijn fouten opgetreden bij het importeren: ',
    'warning'                   => 'WAARSCHUWING: :warning',
    'success_redirecting'       => '"Succes... Omleiden.',
    'setup_successful_migrations' => 'Je database tabellen werden aangemaakt',
    'setup_migration_output' => 'Migratie output:',
    'setup_migration_create_user' => 'Volgende: Maak Gebruiker',
    'importer_generic_error'    => 'Je bestandsimport is voltooid, maar we hebben een fout ontvangen. Dit wordt meestal veroorzaakt door API throttling van derden vanuit een notificatie webhook (zoals Slack) en zou de import zelf niet hebben verstoord, maar je zou dit moeten bevestigen.',
];
