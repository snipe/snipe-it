...
return [
    ...
    'auto_assign_label' => 'Deze gebruiker opnemen bij het automatisch toewijzen van in aanmerking komende licenties',
    'auto_assign_help'  => 'Deze gebruiker overslaan bij automatische toewijzing van licenties',
    ...
    'vip_help' => 'Dit kan handig zijn om belangrijke mensen in je organisatie te markeren als je hen op een speciale manier wilt behandelen.',
    'create_user' => 'Gebruiker aanmaken',
    'create_user_page_explanation' => 'Dit is de accountinformatie die je gebruikt om de site voor het eerst te bezoeken.',
    'email_credentials' => 'E-mail gegevens',
    'email_credentials_text' => 'E-mail mijn gegevens naar bovenstaand e-mailadres',
    'next_save_user' => 'Volgende: Gebruiker Opslaan',
    'all_assigned_list_generation' => 'Gegenereerd op:',
    'email_user_creds_on_create' => 'Gegevens naar gebruiker sturen?',
];
