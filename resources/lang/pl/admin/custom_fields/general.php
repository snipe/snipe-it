...
return array(
    ...
    'encrypt_field'      	        => 'Szyfruje wartość tego pola w bazie danych dla każdego środka trwałego. Odszyfrowana wartość tego pola będzie widoczna tylko dla adminów.',
    ...
    'field_values_help'       => 'Dodaj opcje do wyboru, jedną na każdy wiersz. Puste wiersze poza pierwszym zostaną zignorowane. Oddziel wartości i etykiety poprzez "rury" w każdej linii (opcjonalnie).',
