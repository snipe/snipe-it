...
return [
    ...
    'merge_information' =>  'This will merge the :count users into a single user. Select the user you wish to merge the others into below, and the associated samples, licences, etc will be moved over to the selected user and the other users will be marked as deleted.',
    ...
    'auto_incrementing_asset_tags_enabled_so_now_samples_will_be_created' => 'Note: Generating auto-incrementing sample tags is enabled so sample will be created for rows that do not have "Sample Tag" populated. Rows that do have "Sample Tag" populated will be updated with the provided information.',
    ...
    'error_user_company' => 'Checkout target company and samples company do not match',
    'error_user_company_accept_view' => 'A Sample assigned to you belongs to a different company so you can\'t accept nor deny it, please check with your manager',
    'importer' => [
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box will edit the samples record to reflect this new location. Leaving it unchecked will simply note the location in the audit log. Note that if this samples is checked out, it will not change the location of the person, asset or location it is checked out to.',
    'whoops' => 'Whoops!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'A sample with the sample tag :sample_tag already exists and an update was not requested. No change was made.',
