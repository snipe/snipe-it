...
return [
    ...
    'age'                   => "Age",
    'all_assets'			=> 'All Samples',
    'all'       			=> 'All',
    'archived'              => 'Archived',
    'asset_models'			=> 'Sample Models',
    'asset_model'			=> 'Model',
    'asset'					=> 'Sample',
    'asset_report'          => 'Sample Report',
    'asset_tag'				=> 'Sample Tag',
    'asset_tags'            => 'Sample Tags',
    'assets_available'		=> 'Samples available',
    'accept_assets'         => 'Accept Samples :name',
    'accept_assets_menu'    => 'Accept Samples',
    'audit'				    => 'Audit',
    'audit_report'			=> 'Audit Log',
    'assets'				=> 'Samples',
    'assets_audited'        => 'Samples audited',
    'assets_checked_in_count'     => 'Samples checked in',
    'assets_checked_out_count'     => 'Samples checked out',
    'asset_deleted_warning'     => 'This sample has been deleted. You must restore it before you can assign it to someone.',
    ...
    'custom_report'         => 'Custom Sample Report',
    'dashboard'				=> 'Dashboard',
    'days'      			=> 'days',
    ...
    'error'				    => 'Error',
    'exclude_archived'      => 'Exclude Archived Samples',
    'exclude_deleted'       => 'Exclude Deleted Samples',
    'example'				=> 'Example: ',
    ...
    'include_deleted'       => 'Include Deleted Samples',
    ...
    'importing'         	=> 'Importing',
    'importing_help'        => 'You can import samples, accessories, licenses, components, consumables, and users via CSV file. <br><br>The CSV should be comma-delimited and formatted with headers that match the ones in the <a href="https://snipe-it.readme.io/docs/importing" target="_new">sample CSVs in the documentation</a>.',
    'import-history'        => 'Import History',
    'asset_maintenance'        => 'Sample Maintenance',
    'asset_maintenance_report' => 'Sample Maintenance Report',
    'asset_maintenances'       => 'Sample Maintenances',
    'item'  				=> 'Item',
    'item_name'             => 'Item Name',
    ...
    'logout'				=> 'Logout',
    'lookup_by_tag'     => 'Lookup by Sample Tag',
    ...
    'next_audit_date_help'  => 'If you use auditing in your organization, this is usually automatically calculated based on the sample&apos;s last audit date and audit frequency (in <code>Admin Settings &gt; Alerts</code>) and you can leave this blank. You can manually set this date here if you need to, but it must be later than the last audit date. ',
    'audit_images_help'     => 'You can find audit images in the sample\'s history tab.',
    ...
    'only_deleted'          => 'Only Deleted Samples',
    ...
    'requested_assets'      => 'Requested Samples',
    'requested_assets_menu' => 'Requested Samples',
    ...
    'unaccepted_asset_report' => 'Unaccepted Samples',
    'users'                 => 'Users',
    'viewall'				=> 'View All',
    'viewassets'  			=> 'View Assigned Samples',
    'viewassetsfor'         => 'View Samples for :name',
    'website'               => 'Website',
    ...
    'audit_due_days'        => 'Samples Due for Audit Within :days Day|Samples Due for Audit Within :days Days',
    'checkin_due'           => 'Due for Checkin',
    'checkin_overdue'       => 'Overdue for Checkin',
    'checkin_due_days'      => 'Samples Due for Checkin Within :days Day|Samples Due for Checkin Within :days Days',
    ...
    'changed'               => 'Changed',
    'to'                    => 'To',
    'report_fields_info'    => '<p>Select the fields you would like to include in your custom report, and click Generate. The file (custom-Sample-report-YYYY-mm-dd.csv) will download automatically, and you can open it in Excel.</p>
            <p>If you would like to export only certain Samples, use the options below to fine-tune your results.</p>',
    'range'                 => 'Range',
    ...
    'dashboard_empty'       => 'It looks like you have not added anything yet, so we do not have anything awesome to display. Get started by adding some Samples, accessories, consumables, or licenses now!',
    'new_asset'             => 'New Sample',
    'new_license'           => 'New License',
    'new_accessory'         => 'New Accessory',
    'new_consumable'        => 'New Consumable',
    'collapse'              => 'Collapse',
    'assigned'              => 'Assigned',
    'asset_count'           => 'Sample Count',
    ...
    'asset_information'     => 'Sample Information',
    ...
    'checkin_to_diff_location' => 'You can choose to check this sample in to a location other than this sample\'s default location of :default_location if one is set',
    ...
    'shitty_browser'        => 'No signature detected. If you are using an older browser, please use a more modern browser to complete your sample acceptance.',
    'bulk_soft_delete'      =>'Also soft-delete these users. Their sample history will remain intact unless/until you purge deleted records in the Admin Settings.',
    ...
    'assets_by_status'      => 'Samples by Status',
    'assets_by_status_type'      => 'Samples by Status Type',
    ...
    'merge_information' =>  'This will merge the :count users into a single user. Select the user you wish to merge the others into below, and the associated samples, licenses, etc will be moved over to the selected user and the other users will be marked as deleted.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Generating auto-incrementing sample tags is disabled so all rows need to have the "Sample Tag" column populated.',
    'auto_incrementing_asset_tags_enabled_so_now_samples_will_be_created' => 'Note: Generating auto-incrementing sample tags is enabled so samples will be created for rows that do not have "Sample Tag" populated. Rows that do have "Sample Tag" populated will be updated with the provided information.',
    ...
    'error_user_company' => 'Checkout target company and sample company do not match',
    'error_user_company_accept_view' => 'An Sample assigned to you belongs to a different company so you can\'t accept nor deny it, please check with your manager',
    'importer' => [
        ...
        'checked_out_to_tag' => 'Checked Out to: Sample Tag',
    ...
    'copied' => 'Copied!',
    'status_compatibility' => 'If samples are already assigned, they cannot be changed to a non-deployable status type and this value change will be skipped.',
    'rtd_location_help' => 'This is the location of the sample when it is not checked out',
    ...
    'no_requestable' => 'There are no requestable samples or sample models.',

    'countable' => [
        'accessories'  => ':count Accessory|:count Accessories',
        'assets'  => ':count Sample|:count Samples',
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box will edit the sample record to reflect this new location. Leaving it unchecked will simply note the location in the audit log. Note that if this sample is checked out, it will not change the location of the person, sample or location it is checked out to.',
    'whoops' => 'Whoops!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'An sample with the sample tag :sample_tag already exists and an update was not requested. No change was made.',
