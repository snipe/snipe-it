...
return [
    ...
    'not_deleted'           => ':item_type no está eliminado; por lo tanto, no se puede restaurar',
    'create'				=> 'Crear nuevo',
    ...
    'unaccepted_profile_warning'   => 'Tiene :count elemento(s) que requiere(n) aceptación. Haga clic aquí para aceptarlo(s) o rechazarlo(s)',
