...
return array(
    ...
    'custom_forgot_pass_url_help'	=> 'Ceci remplace l\'URL de mot de passe intégré oublié de la page d\'accueil, utile pour rediriger les utilisateurs vers le serveur LDAP.  Cela va désactiver la fonctionnalité du mot de passe oublié au niveau local.',
  ...
  'default_language'			=> 'Langue par défaut',
	'default_eula_help_text'	=> 'Vous pouvez également associer les licences d\'utilisation personnalisées à des catégories spécifiques d\'actifs .',
    ...
    'footer_text_help'          => 'Ce texte apparaît dans le pied de page du côté droit. Links are allowed using <a href="https://help.github.com/articles/github-flavored-markdown/">Github flavored markdown</a>. Line breaks, headers, images, etc may result in unpredictable results.',
    ...
    'ldap_login_test_help'      => 'Entrez un nom d\'utilisateur et mot de passe LDAP valide depuis la base DN que vous avez spécifié ci-dessus afin de tester si votre configuration LDAP est correcte. VOUS DEVEZ D\'ABORD ENREGISTRER VOS PARAMETRES LDAP MIS A JOUR.',
    'ldap_login_sync_help'      => 'Ceci vérifie uniquement que LDAP se synchronise correctement. Si votre requête d\'authentification LDAP est incorrecte, les utilisateurs peuvent ne pas pouvoir se connecter. VOUS DEVEZ D\'ABORD ENREGISTRER VOS PARAMETRES LDAP MIS A JOUR.',
    'ldap_server'               => 'Serveur LDAP',
    'ldap_server_help'          => 'Cela devrait commencer par ldap:// (non crypté ou TLS) ou ldaps:// (SSL)',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de Snipe-IT. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'autenthification.',
    'logo'                    	=> 'Logo',
    'logo_print_assets'         => 'Utiliser pour les impressions',
    ...
    'show_archived_in_list_text'     => 'Afficher tous les actifs archivés dans la liste "Tous les actifs"',
    'show_images_in_email'     => 'Afficher les images dans les emails',
    'show_images_in_email_help'   => 'Décochez cette case si votre installation Snipe-IT est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs emails.',
    ...
    'version_footer'            => 'Version dans le pied de page ',
