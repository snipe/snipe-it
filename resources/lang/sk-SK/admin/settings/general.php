...
'ldap_location_help'             => 'Pole Ldap lokalita by sa malo použiť, ak <strong>sa OU nepoužíva v základne väzbe DN.</strong> Nechajte toto prázdne, ak sa používa OU vyhľadávanie.',
    ...
    'ldap_pw_sync'              => 'LDAP synhronizácia hesla',
    'ldap_pw_sync_help'         => 'Zrušte zaškrtnutie tohoto políčka, ak si neželáte uchovávať heslá LDAP synchronizované s lokálnymi heslami. Ak to zakážete, znamená to, že sa používatelia nemusia vedieť prihlásiť pokiaľ je Váš LDAP server z nejaké dôvodu nedostupný.',
    ...
    'require_checkinout_notes'  => 'Vyžadovať poznámky pri odovzdaní a prevzatí',
    'require_checkinout_notes_help_text'    => 'Aktiváciou tejto funkcie bude vyžadovať, aby bolo pole s poznámkou vždy vyplnené, keď je realizované odovzdanie alebo prijatie majetku.',
    'left'        => 'vľavo',
    'right'        => 'vpravo',
    'top'        => 'hore',
    'bottom'        => 'dole',
