...
'ldap_location_help'             => 'LDAP platsfältet bör användas om <strong>ett OU inte används i Base Bind DN.</strong> Lämna detta tomt om en OU-sökning används.',
    ...
    'help_default_will_use' => '<code>:default</code> kommer att använda värdet från <code>:setting_name</code>. <br>Observera att värdet på streckkoderna måste följa respektive streckkodspecifikation för att kunna genereras. Se <a href="https://snipe-it.readme.io/docs/barcodes">dokumentation<i class="fa fa-external-link"></i></a> för mer information. ',
    'default'               => 'Standard',
    'none'                  => 'Inga',
