...
return array(
    ...
    'delete' => array(
        ...
        'assoc_assets'	 => 'Denna leverantör är för närvarande är associerade med: asset_count tillgång(ar) och kan inte tas bort. Vänligen uppdatera dina tillgångar för att inte längre referera denna leverantör och försök igen. ',
