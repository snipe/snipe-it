...
return [
    ...
    'requestable_items'     => 'Begärbara saker',
    'requested'				=> 'Begärda',
    ...
    'request_item'          => 'Begär denna artikel',
    ...
    'webhook_test_msg'        => 'Där ser man! Ser ut som din :app integrering med Snipe-IT fungerar!',
    ...
    'checkin_tooltip' => 'Checka in denna artikel så den blir tillgänglig för återanvändning, återbildning, osv',
    ...
    'hello_name'            => 'Hej, :name!',
    'unaccepted_profile_warning'   => 'Du har en artikel som kräver godkännande. Klicka här för att acceptera eller avböja det | Du har :count artiklar som kräver godkännande. Klicka här för att acceptera eller avböja dem',
    ...
    'quickscan_bulk_help' => 'Markering av denna ruta kommer att justera tillgångshistoriken till att visa den nya platsen. Om du lämnar rutan omarkerad noteras platsen i inventeringsloggen. Observera om tillgången är utcheckad kommer inte ändringar hos personen, tillgången eller platsen att göras.',
    'whoops' => 'Hoppsan!',
