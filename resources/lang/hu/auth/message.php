...
return array(
    ...
    'throttle'               => 'Túl sok sikertelen bejelentkezési kísérlet. Kérjük, :seconds másodperc múlva próbálja újra.',

    'two_factor' => array(
        'already_enrolled'      => 'Ez az eszköz már regisztrálva van.',
        'success'               => 'Sikeresen bejelentkezett.',
        'code_required'         => 'Két lépcsős azonosítás szükséges.',
        'invalid_code'          => 'A megadott kód érvényletelen.',
    ),
    ...
    'logout' => array(
        'error'   => 'Kijelentkezés közben probléma lépett fel, kérjük próbálja újra.',
    ...
    'forgot-password' => array(
        'error'   => 'A jelszó visszaállító email kiküldése közben probléma lépett fel, kérjük próbálja újra.',
