...
return array(
  ...
  'default_language'			=> 'Standardsprache',
    ...
    'login_remote_user_text'         => 'Remote User authentifizierung',
    'login_remote_user_enabled_text'    => 'Aktiviere Remote User authentifizierung',
    'login_remote_user_enabled_help'    => 'Diese Option aktiviert die authentifizierung über den REMOTE_USER Header nach dem "Common Gateway Interface (rfc3875)"',
    'login_common_disabled_text' => 'Deaktiviere andere Authentifizierungsverfahren',
    'login_common_disabled_help' => 'Diese option deaktiviert andere Authentifizierungsverahren. Sie sollten diese Option nur aktivieren wenn Sie sicher sind das der Login über den REMOTE_USER Header funktioniert',
    'login_remote_user_custom_logout_url_text' => 'Benutzerdefinierte logout URL',
    'login_remote_user_custom_logout_url_help' => 'Wenn Sie hier eine URL eintragen, werden Benutzer nach dem Logout in SnipeIT zu dieser weitergeleitet. Dieses Verhalten ist insbesondere nützlich um Benutzersessions beim Authentifizierungsprovider zu schließen.',
    'logo'                    	=> 'Logo',
