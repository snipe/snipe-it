...
class Asset extends Depreciable
{
    ...
    */
    ...
    public static function getExpiringWarrantee() {
	    
	    return Asset::where('archived','=','0')
		->whereNotNUll('warranty_months')
		->whereNotNUll('purchase_date')
		->whereRaw(DB::raw('DATE_ADD(`purchase_date`,INTERVAL `warranty_months` MONTH) <= DATE(NOW() + INTERVAL 1 MONTH) AND DATE_ADD(`purchase_date`,INTERVAL `warranty_months` MONTH) > NOW()'))
