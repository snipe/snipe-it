...
{{ Form::open(['method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'autocomplete' => 'off']) }}
    ...
    <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-5">
            ...
            {{ $errors->first('first_name', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-5">
            ...
            {{ $errors->first('last_name', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
        </div>
    </div>
    ...
    <!-- Location -->
        <div class="form-group {{ $errors->has('phone') ? 'error' : '' }}">
            ...
            <div class="col-md-5">
                ...
                {{ $errors->first('location_id', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                </div>
            </div>
        </div>
    ...
    <div class="form-group {{ $errors->has('website') ? ' has-error' : '' }}">
        ...
        <div class="col-md-5">
            ...
            {{ $errors->first('website', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
        </div>
    </div>
    ...
    <div class="form-group {{ $errors->has('gravatar') ? ' has-error' : '' }}">
        ...
        <div class="col-md-5">
            ...
            {{ $errors->first('gravatar', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
