...
<p><strong><a href="{{{ Config::get('app.url') }}}/account/accept-asset/{{ $log_id }}">I have read and agree to the terms of use, and have received this item.<br>{{{ Config::get('app.url') }}}/account/accept-asset/{{ $log_id }}</a></strong></p>
@endif
