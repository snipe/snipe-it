    ...
    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            ...
            <div class="form-group {{ $errors->has('asset_id') ? ' has-error' : '' }}">
                ...
                <div class="col-md-10">
                    ...
                    {{ $errors->first('asset_id', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                </div>
            </div>
            ...
            <label class="col-md-2 control-label"></label>
                <div class="col-md-7">
                    ...
                    <button type="submit"  class="btn btn-success"><i class="fa fa-ok icon-white"></i>  @lang('general.checkout')</button>
                </div>
            </div>
