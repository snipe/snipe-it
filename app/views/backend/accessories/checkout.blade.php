...
<form class="form-horizontal" method="post" action="" autocomplete="off">
    ...
    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            ...
            <label class="col-sm-3 control-label">@lang('admin/accessories/general.accessory_name')</label>
                <div class="col-md-6">
            ...
            <!-- accessory name -->
            <div class="form-group">
            <label class="col-sm-3 control-label">@lang('admin/accessories/general.accessory_category')</label>
                <div class="col-md-6">
