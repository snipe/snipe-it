...
<div class="row form-wrapper">
                ...
                <label for="asset_tag" class="col-md-2 control-label">@lang('admin/hardware/form.tag')
                 <i class='fa fa-asterisk'></i></label>
                    ...
                    <div class="col-md-7">
                        ...
                        {{ $errors->first('asset_tag', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('model_id') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7">
                    ...
                    @endif
                    {{ $errors->first('model_id', '<br><span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('mac_address') ? ' has-error' : '' }}">
                <label for="mac_address" class="col-md-2 control-label">@lang('admin/hardware/form.mac_address')</label>
                    <div class="col-md-7">
                        ...
                        {{ $errors->first('mac_address', '<br><span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
            </div>
            @endif
            ...
            <div class="form-group {{ $errors->has('warranty_months') ? ' has-error' : '' }}">
                ...
                <div class="col-md-2">
                    ...
                    {{ $errors->first('warranty_months', '<br><span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
                <label for="status_id" class="col-md-2 control-label">@lang('admin/hardware/form.status') <i class='fa fa-asterisk'></i></label>
                    <div class="col-md-7">
                        ...
                        {{ $errors->first('status_id', '<br><span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
            </div>
