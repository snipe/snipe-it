...
<div class="row form-wrapper">
            ...
            <div class="form-group {{ $errors->has('model_id') ? ' has-error' : '' }}">
                ...
                <div class="col-md-7">
                    ...
                    @endif
                    {{ $errors->first('model_id', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->has('mac_address') ? ' has-error' : '' }}">
                <label for="mac_address" class="col-md-2 control-label">@lang('admin/hardware/form.mac_address')</label>
                    <div class="col-md-7">
                        ...
                        {{ $errors->first('mac_address', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
            </div>
            @endif
            ...
            <div class="form-group {{ $errors->has('warranty_months') ? ' has-error' : '' }}">
                ...
                <div class="col-md-2">
                    ...
                    {{ $errors->first('warranty_months', '<span class="alert-msg"><i class="fa fa-remove-sign"></i> :message</span>') }}
                    </div>
                </div>
            </div>
