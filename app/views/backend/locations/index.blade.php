...
<div class="row header">
    <div class="col-md-12">
        <a href="{{ route('create/location') }}" class="btn btn-success pull-right"><i class="fa fa-plus-sign icon-white"></i>  @lang('general.create')</a>
...
<table id="example">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('update/location', $location->id) }}" class="btn btn-warning"><i class="fa fa-pencil icon-white"></i></a>
