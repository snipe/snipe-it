...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<div class="tab-pane active" id="tab-general">
			...
			<div class="form-group {{ $errors->has('name') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-4" type="text" name="name" id="name" value="{{ Input::old('name', $location->name) }}" />
			...
			<div class="form-group {{ $errors->has('address') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-4" type="text" name="address" id="address" value="{{ Input::old('address', $location->address) }}" />
			...
			<div class="form-group {{ $errors->has('address2') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-4" type="text" name="address2" id="address2" value="{{ Input::old('address2', $location->address2) }}" />
			...
			<div class="form-group {{ $errors->has('city') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-4" type="text" name="city" id="city" value="{{ Input::old('city', $location->city) }}" />
			...
			<div class="form-group {{ $errors->has('state') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-2" type="text" name="state" id="state" value="{{ Input::old('state', $location->state) }}" />
			...
			<div class="form-group {{ $errors->has('zip') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-2" type="text" name="zip" id="zip" value="{{ Input::old('zip', $location->zip) }}" />
			...
			<div class="form-group {{ $errors->has('country') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="col-md-2" type="text" name="country" id="country" value="{{ Input::old('country', $location->country) }}" />
