...
class AssetMaintenancesTransformer
{
    ...
    public function transformAssetMaintenance(AssetMaintenance $assetmaintenance)
    {
        $array = [
            ...
            'location' => (($assetmaintenance->assignedTo) && ($assetmaintenance->assignedTo->location)) ? [
                'id' => (int) $assetmaintenance->assignedTo->location->id,
                'name'=> e($assetmaintenance->assignedTo->location->name),
            ...
            'assigned_to' => ($assetmaintenance->assigned_to) ? ['id' => $assetmaintenance->assignedTo->id, 'name'=> e($assetmaintenance->assignedTo->getFullNameAttribute())]: null,
